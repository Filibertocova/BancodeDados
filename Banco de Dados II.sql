...
SELECT nome, descripcao FROM clientes
INNER JOIN produto
ON produto.cli_id = clientes.cli_id;

SELECT nome, descripcao
FROM
clientes LEFT JOIN produto
on produto.cli_id = clientes.cli_id;

SELECT nome, descripcao
FROM
clientes RIGHT JOIN produto
on produto.cli_id = clientes.cli_id;


SELECT nome, descripcao FROM
clientes LEFT JOIN produto
on produto.cli_id = clientes.cli_id;
UNION
SELECT nome, descripcao FROM
